...
export default function Logo({ isMinimized }) {
    return (_jsxs(Box, { sx: {
            ...
            width: '100%',
            gap: 2.5,
        }, children: [_jsx(LogoIcon, {}), !isMinimized && _jsx(Typography, { variant: "h4", children: APP_NAME })] }));
}
